...
project = 'OpenFed'
copyright = '2021, FederalLab'
author = 'FederalLab Authors'
...
latex_documents = [
    (master_doc, 'OpenFed.tex', 'OpenFed Documentation', 'FederalLab',
     'manual'),
]
...
man_pages = [(master_doc, 'OpenFed', 'OpenFed Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'OpenFed', 'OpenFed Documentation', author, 'OpenFed',
